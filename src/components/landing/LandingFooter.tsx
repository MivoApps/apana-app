    ...
    <footer className="bg-white border-t border-[#bccac0]/30 pt-16 pb-12 text-[#0b1c30]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 mb-16">
        <div className="bg-linear-to-br from-[#00855d] via-[#059669] to-[#006c49] rounded-3xl p-8 sm:p-12 text-white text-center flex flex-col items-center relative overflow-hidden shadow-xl shadow-[#059669]/20">
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-emerald-200 bg-white/15 px-3 py-1 rounded-full mb-4 border border-white/20">
            Empieza en 1 minuto
          </span>
          ...
          <p className="mt-4 text-sm sm:text-base text-emerald-100 max-w-xl leading-relaxed">
            Sin contratos forzosos y con control total de tus productos y ventas por WhatsApp.
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center gap-3.5 w-full sm:w-auto">
            <Link href="/login" className="w-full sm:w-auto">
              <Button
                variant="primary"
                size="lg"
                className="w-full sm:w-auto font-bold bg-white text-[#00855d] hover:bg-emerald-50 px-8 py-3.5 shadow-lg flex items-center justify-center gap-2"
              >
            ...
            <Link href="/s/panaderia-don-jose" target="_blank" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto font-semibold text-white bg-white/15 hover:bg-white/25 border border-white/30 px-6 py-3.5 rounded-xl text-sm transition-all">
                Ver tienda demo
              </button>
            </Link>
          </div>
